...
const projects = [
  ...
  },
  {
    ...
    description:
      "We aim to file 100+ patents/ copyriights by 2025 for middle school champs.",
    link: "/parvi",
  },
  {
    title: "Monetize your innovative tool",
    description:
      "Platform for champs to monitize patented copyrighted Ideas Manufacturing Provided by Pravi, with upto 20% royalty provided for champs",
    link: "/parvi",
  },
  {
    title: "Appraisal By Pravi",
    description:
      "Our single batch consist of 20 students out of which top 5 students provided 100% refund",
    link: "/parvi",
  },
  {
    title: "Course Ke Sath Bhi Course Ke Baad Bhi",
    description:
      "Patents/ Copyrights last a lifetime preserving the values of ideas. We Generate Student Id that can be used for seemless support by our techsavy team upto 6 month after enrollment.",
    link: "/parvi",
  },
];
...
const Parvi = () => {
  return (
    <div className="xsm:overflow-x-hidden sm:overflow-x-auto">
      <Navbar />
      <HeroSection title="Pravi" content="We don't teach, We Educate" />
      <AboutUsP
        description={aboutUs}
        url={ParviLogo}
        btnTitle="Learn More About Us"
      />
      <WhyPravi />
      <Catalogue />
      <Projects />
