  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col-reverse md:flex-row self-center justify-around align-middle mt-4 p-5'>
        <div className="lg:w-1/3 md:w-1/2  p-8 text-justify flex flex-col">
          ...
          {btnTitle && (
            <div className="mt-4">
              <a 
                ...
                target="_blank" 
                className="flex items-center gap-2 bg-gray-700 text-white   py-2 px-4 rounded-lg transition transform hover:-translate-y-1 hover:scale-105"
              >
