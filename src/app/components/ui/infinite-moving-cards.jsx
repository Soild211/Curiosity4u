...
export const InfiniteMovingCards = ({
  ...
  return (
    (<div
      ref={containerRef}
      className={cn(
        "scroller relative z-20  max-w-full overflow-hidden  [mask-image:linear-gradient(to_right,transparent,white_20%,white_99%,transparent)]",
        className
      )}>
      <ul
        ref={scrollerRef}
